...
//激光雷达线数和远距离点选取（32，29），（16,13）
uint16_t lidar_lines = 32;
int far_distance = 29;

//局部栅格地图尺寸，单位m
const int FRONT_SCAN_RANGE = 4000;      //前方扫描有效范围40m
const int REAR_SCAN_RANGE = 4000;       //后方扫描有效范围40m
const int LEFT_SCAN_RANGE = 1000;		//左方扫描有效范围长10m
const int RIGHT_SCAN_RANGE = 1000;	    //右方扫描有效范围10m
